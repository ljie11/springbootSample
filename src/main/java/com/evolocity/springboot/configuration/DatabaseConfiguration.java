package com.evolocity.springboot.configuration;
...
@Configuration
@EnableJpaRepositories(basePackages = "com.evolocity.springboot.repositories",
...
public class DatabaseConfiguration {
	...
	public LocalContainerEntityManagerFactoryBean entityManagerFactory() throws NamingException {
		...
		factoryBean.setPackagesToScan(new String[] { "com.evolocity.springboot.model" });
